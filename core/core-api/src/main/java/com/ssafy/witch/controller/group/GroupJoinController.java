...
public class GroupJoinController {
  ...
  public WitchApiResponse<GroupJoinRequestListResponse> getJoinRequests(
    ...
    GroupJoinRequestListOutput output = handleGroupJoinRequestUseCase.getGroupJoinRequestList(
        command);

    GroupJoinRequestListResponse response = groupResponseMapper.toGroupJoinRequestListResponse(
        output);
