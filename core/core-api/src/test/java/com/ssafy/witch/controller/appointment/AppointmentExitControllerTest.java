...
@WebMvcTest(AppointmentExitController.class)
class AppointmentExitControllerTest extends RestDocsTestSupport {

  @MockBean
  private ExitAppointmentUseCase exitAppointmentUseCase;

  @WithMockWitchUser
  @Test
  void exit_appointment_200() throws Exception {

    String appointmentId = "appointment-id-example";

    mvc.perform(delete("/appointments/{appointmentId}/members/me", appointmentId)
  ...
  @WithMockWitchUser
  @Test
  void exit_appointment_400_appointment_not_exists() throws Exception {

    String appointmentId = "appointment-id-example";

    doThrow(new AppointmentNotFoundException())
        .when(exitAppointmentUseCase).exitAppointment(any());
  ...
  @WithMockWitchUser
  @Test
  void exit_appointment_400_not_appointment_member() throws Exception {
  ...
  @WithMockWitchUser
  @Test
  void exit_appointment_400_user_is_leader() throws Exception {
