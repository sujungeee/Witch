...
@WebMvcTest({SnackSoundController.class, FileRequestMapper.class, FileResponseMapper.class,
    SnackRequestMapper.class})
class SnackSoundControllerTest extends RestDocsTestSupport {
  ...
  @WithMockWitchUser
  @Test
  void generate_snack_sound_presigned_url_200() throws Exception {

    PresignedUrlRequest request = new PresignedUrlRequest("snack-sound.mp3");
    ...
    mvc.perform(post("/snacks/snack-sound/presigned-url")
        ...
        .andDo(restDocs.document(
            ...
            requestFields(
                fieldWithPath("fileName")
                    ...
                    .attributes(constraints("업로드할 파일의 확장자가 mp3 또는 mpeg여야 합니다."))
            ),
            responseFields(
  ...
  @WithMockWitchUser
  @Test
  void generate_snack_sound_presigned_url_400_unsupported_file_format() throws Exception {
